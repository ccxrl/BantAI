...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(348, 441)
        Dialog.setStyleSheet("\n"
"background-color: rgb(151, 227, 227);")
        self.label_2 = QtWidgets.QLabel(Dialog)
        self.label_2.setGeometry(QtCore.QRect(70, 60, 211, 41))
        font = QtGui.QFont()
        ...
        self.label_3.setGeometry(QtCore.QRect(120, 350, 121, 71))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "You are disgusted"))    
