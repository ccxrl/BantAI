...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(340, 689)
        Dialog.setStyleSheet("\n"
"background-color: rgb(151, 227, 227);")
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(40, 190, 251, 71))
        font = QtGui.QFont()
        ...
        self.frame.setGeometry(QtCore.QRect(40, 310, 251, 161))
        self.frame.setStyleSheet("background-color:white")
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.frame_2 = QtWidgets.QFrame(Dialog)
        self.frame_2.setGeometry(QtCore.QRect(20, 30, 301, 251))
        self.frame_2.setStyleSheet("background-color:white")
        self.frame_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_2.setObjectName("frame_2")
        self.opencam2 = QtWidgets.QLabel(Dialog)
        self.opencam2.setGeometry(QtCore.QRect(100, 540, 151, 141))        
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "You are disgusted."))  
        self.label.setText(_translate("Dialog", "You Are Disgusted"))      
