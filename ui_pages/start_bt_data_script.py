...
avg_bpm = None
spo2 = None  # Assuming you will also receive SpO2 data

async def notification_handler(sender, data):
    """Handle incoming data from BLE device"""
    global avg_bpm, spo2  # Declare as global to modify
    try:
        ...
        if "BPM=" in decoded_data:
            ...
            spo2 = float(bpm_data[2].split("=")[1])
            print(f"Heart Rate: {bpm} BPM, Average Heart Rate: {avg_bpm} BPM, SpO2: {spo2}")
